            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  I specialize in crafting native websites, bringing expertise in JavaScript frameworks to the table and optimized performance.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                  Worked with diverse teams and clients, honing my skills and expertise along the way. From designing sleek user interfaces to implementing robust frontend functionalities,
